    ...
    def doRollover(self):
        ...
        if self.archive_mode == "zip":
            ...
            try:
                ...
                logging.getLogger("RunUpdates").error(f"Archive failed: {ex}")
            ...
            try:
                ...
                logging.getLogger("RunUpdates").error(f"TGZ archive failed: {ex}")
                compression_success = False
        ...
        if compression_success:
            ...
            logging.getLogger("RunUpdates").warning(
                f"Archive skipped; preserved rotated file: {rotated_file}"
            )
